...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 5003470856770371782, ; hash 0x456fe63c15d140c6, from name: aot-MovilAPP1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 122
	%struct.DSOCacheEntry {
		i64 5069459011234124204, ; hash 0x465a561c900351ac, from name: libaot-MovilAPP1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 123
	...
	%struct.DSOCacheEntry {
		i64 5281706572937044258, ; hash 0x494c6424f7c22122, from name: MovilAPP1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 130
	...
	%struct.DSOCacheEntry {
		i64 5473529104802137000, ; hash 0x4bf5e1b8877e43a8, from name: MovilAPP1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 135
	...
	%struct.DSOCacheEntry {
		i64 13681125541305437175, ; hash 0xbddd1f31b108cbf7, from name: libaot-MovilAPP1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 363
	...
	%struct.DSOCacheEntry {
		i64 17312241772631826452, ; hash 0xf041702b03662014, from name: aot-MovilAPP1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 461
...
@.env.3 = private unnamed_addr constant [37 x i8] c"2c56447c-e818-474d-a75b-de31ade3e8b8\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.movilapp1\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-MovilAPP1.dll.so\00", align 16
...
@.DSOCacheEntry.73_name = private unnamed_addr constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 16
@.DSOCacheEntry.74_name = private unnamed_addr constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 16
@.DSOCacheEntry.75_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.RegularExpressions.dll.so\00", align 16
@.DSOCacheEntry.76_name = private unnamed_addr constant [38 x i8] c"libaot-System.Threading.Thread.dll.so\00", align 16
@.DSOCacheEntry.77_name = private unnamed_addr constant [31 x i8] c"libaot-System.Threading.dll.so\00", align 16
