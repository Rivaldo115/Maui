...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 413897259, ; hash 0x18ab922b, from name: MovilAPP1.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1591890998, ; hash 0x5ee25436, from name: MovilAPP1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 171
	...
	%struct.DSOCacheEntry {
		i64 2223283242, ; hash 0x84849c2a, from name: aot-MovilAPP1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 248
	...
	%struct.DSOCacheEntry {
		i64 2369721356, ; hash 0x8d3f140c, from name: aot-MovilAPP1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 266
	...
	%struct.DSOCacheEntry {
		i64 2787593790, ; hash 0xa6274e3e, from name: libaot-MovilAPP1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 323
	...
	%struct.DSOCacheEntry {
		i64 3221539146, ; hash 0xc004c94a, from name: libaot-MovilAPP1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MovilAPP1.dll.so
		ptr null; void* handle (0x0)
	}, ; 382
